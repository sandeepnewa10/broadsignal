...
define( 'BSWB__PLUGIN_URI', plugin_dir_url( __FILE__ ) );
...
function bswb_add_enqueue_script() {
    ...
    wp_enqueue_script( 'js2', 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', false );

}

function bswb_add_styles() {
	wp_enqueue_style( 'p-custom-stylsheet', BSWB__PLUGIN_URI . 'css/bswb-styles.css' );
