...
function upbootwp_scripts() {
	...
	wp_enqueue_style( 'stylesheet-css', get_template_directory_uri().'/css/style.css', array(), '1.1');
	...
	wp_enqueue_script( 'owl-carousel', get_template_directory_uri().'/js/owl.carousel.min.js',array(),'1.1',true);
		wp_enqueue_script( 'custom-js', get_template_directory_uri().'/js/init.js',array(),'1.1',true);
}
