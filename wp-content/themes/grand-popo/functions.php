...
/*
        ...
        register_sidebar(array(
        'name'          => __('Footer Left','grand-popo'),
        'id'            => 'footer1',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
    ...
    register_sidebar(array(
        'name'          => __('Footer Contact','grand-popo'),
        'id'            => 'footer2',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
    ...
    register_sidebar(array(
        'name'          => __('Footer Menu','grand-popo'),
        'id'            => 'footer-menu',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
        ...
        register_sidebar(array(
        'name'          => __('Footer Middle','grand-popo'),
        'id'            => 'footer1',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
...
function grand_popo_scripts() {
    wp_enqueue_style('custom-style', get_template_directory_uri() . '/assets/stylesheets/broadsignal.css', array(), time(), 'all');   
    wp_enqueue_style('bootstrap', get_template_directory_uri() . '/assets/stylesheets/bootstrap.css', array(), time(), 'all');  wp_enqueue_style('grand_popo-google-font', grand_popo_google_fonts_url(), array());   
...
/*
    if(is_page('demo')):
            wp_enqueue_style( 'style', get_template_directory_uri() . '/assets/stylesheets/demo.css', false, null, 'all');
    endif;

    */

    wp_enqueue_script('grand_popo-bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), 'null', true);
     wp_enqueue_script('grand_popo-bootstrap', get_template_directory_uri() . '/assets/js/init.js', array(), 'null', true);
    ...
    wp_enqueue_script('grand_popo-product-table', get_template_directory_uri() . '/assets/js/init.js',  array('jquery','grand_popo-select2-js'), null, true);
    

     wp_enqueue_script('grand_popo-product', get_template_directory_uri() . '/assets/js/product.js', array(), 'null', true);
